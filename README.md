...
- **🧵 [Kizilay Shelter Systems: AI-Powered Production Predictor & Optimizer](https://github.com/mesudegrn/embroidery_machine_ai_visual_processing)** Developed an interactive decision support system using **Streamlit**, **Computer Vision**, and **Machine Learning**. The application first utilizes **TensorFlow** models and image processing to automatically classify the specific type of embroidery. Based on this classification, it predicts production durations and daily capacities while providing dynamic optimization suggestions. It compares real-time manufacturing inputs with mathematically optimal parameters to identify efficiency gaps.
...
- **📊 [OliveGold Cooperative: Profit-Maximizing Olive Oil Production and Distribution Model](https://github.com/mesudegrn/Olivegold-Company-Transportation-Optimization-Model/tree/main)** Linear programming optimization model for Türkiye's premium olive oil production. Navigates supply constraints, blending ratios, and export opportunities to maximize total cooperative profit.


- **📈 [Cybersecurity Case Study: Comparative Analysis of Detection and Resolution Metrics](https://github.com/mesudegrn/statistical-comparison-between-cyber-defense-companies)** In-depth statistical analysis conducted as part of the **IE266 course at METU**. Leverages data from 3 organizatons to compare detection and resolution times for ransomware, DDoS, and phishing attacks.

## 🛠️ Tools & Technologies
- **Python & AI:** TensorFlow, Computer Vision, Machine Learning, Streamlit, Scikit-learn, Pandas, NumPy, Pyomo
